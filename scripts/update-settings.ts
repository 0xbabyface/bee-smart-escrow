...
async function main() {
  ...
  // await tx.wait();
  // tx = await agentManager.addTopAgent('0xF2b3CCBc45bdA7d0aa5a25172C0a270ad55D2473', 3, true, 'enpeng');
  // await tx.wait();
  ...
  tx = await agentManager.setAgentStarLevel('0xb20191CbeD6c9d9122b787Ee2bbbD758FD5287CE', 3);
  await tx.wait();
