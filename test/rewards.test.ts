...
describe("BeeSmart", async function () {
  ...
  describe("rewards for traders", function () {
    ...
    it('test case 3-3-3', async function() {
      ...
      await agentManager.connect(agent1).addAgent(agent1.address, agent2.address, 3, true);
      await agentManager.connect(agent1).addAgent(agent1.address, agent4.address, 3, true);
      await agentManager.connect(agent1).addAgent(agent2.address, agent3.address, 3, true);
      await agentManager.connect(agent1).addAgent(agent4.address, agent5.address, 3, true);
      await agentManager.connect(agent1).addAgent(agent4.address, agent6.address, 3, true);
